package org.nico.voice;

import edu.cmu.sphinx.api.Configuration;
import edu.cmu.sphinx.api.LiveSpeechRecognizer;
import edu.cmu.sphinx.api.SpeechResult;
import org.nico.Arceus;
import org.nico.util.SpeechUtil;
        ...
        while (true) {
            ...
            if (Objects.nonNull(speechResult)) {
                ...
                if (speechRecognitionResult.startsWith("jarvis ")) {
                    String numberText = SpeechUtil.convertNumbers(speechRecognitionResult);
                    Arceus.getInstance().handleCommand(numberText);
                }
            }
        }
    }

...
public class SpeechUtil {
    ...
    private final static String[] SINGLENUMBERS = {"null", "eins", "zwei", "drei", "vier", "fünf", "sechs", "sieben", "acht", "neun", "zehn", "elf", "zwölf", "dreizehn", "vierzehn", "fünfzehn", "sechzehn", "siebzehn", "achtzehn", "neunzehn"};

    private final static String[] COMBONUMBERS = {"ein", "zwei", "drei", "vier", "fünf", "sechs", "sieben", "acht", "neun"};
                ...
                for (int i = 0; i < COMBONUMBERS.length; i++) {
                    if (COMBONUMBERS[i].equals(word)) {
                        ...
                        if ("und".equals(nextWord)) {
                            ...
                            sentenceBuilder.append(i + 1).append(" und ");
                        } else {
                            sentenceBuilder.append(i + 1).append(" ");
                        }
                        foundNumber = true;
                        break;
                    }
